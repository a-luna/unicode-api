...
#     API_VERSION: str = "/v1"
#     REDIS_URL: RedisDsn = (
#         RedisDsn(DEFAULT_REDIS_URL, scheme="redis")
#         if os.environ.get("ENV") == "DEV"
#         else RedisDsn(os.environ.get("REDIS_URL", DEFAULT_REDIS_URL), scheme="redis")
#     )
#     SERVER_NAME: str = "unicode-api.aaronluna.dev"
#     SERVER_HOST: AnyHttpUrl = AnyHttpUrl("https://unicode-api.aaronluna.dev", scheme="https")
#     CACHE_HEADER: str = "X-UnicodeAPI-Cache"
