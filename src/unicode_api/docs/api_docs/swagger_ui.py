...
from unicode_api.docs.api_docs.content.block import (
    BLOCK_ENDPOINTS,
    UNICODE_BLOCK_OBJECT_INTRO,
    UNICODE_BLOCK_OBJECT_PROPERTIES,
)
from unicode_api.docs.api_docs.content.character import (
    CHARACTER_ENDPOINTS,
...
from unicode_api.docs.api_docs.content.codepoint import CODEPOINT_CONTENT, CODEPOINTS_ENDPOINTS
from unicode_api.docs.api_docs.content.intro import (
    INTRODUCTION,
    LOOSE_MATCHING_HTML,
    PAGINATION_HTML,
...
from unicode_api.docs.api_docs.content.plane import (
    PLANE_ENDPOINTS,
...
BLOCK_API_ENDPOINTS = create_swagger_details_element_for_api_endpoints(content=BLOCK_ENDPOINTS, open=True)
PLANE_API_ENDPOINTS = create_swagger_details_element_for_api_endpoints(content=PLANE_ENDPOINTS, open=True)
