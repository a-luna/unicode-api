...
from unicode_api.core.encoding import get_uri_encoded_value
from unicode_api.docs.dependencies import (
...
<ul class="param-notes">
    <li class=\"note\">This value is optional (default: <code>page=1</code>)</li>
</ul>
...
<ul class="param-notes">
    <li class=\"note\">This value is optional</li>
...
VERBOSE_DESCRIPTION = """
<ul class="param-notes">
    <li class=\"note\">This value is optional (default: <code>verbose=false</code>)</li>
</ul>
...
def get_description_and_values_table_for_property_group() -> str:
    return (
        '<ul class="param-notes">'
        + '<li class="note">This value is optional (default: <code>show_props=Minimum</code>)</li>'
        + '<li class="loose-match">The <a href="#loose-matching">Loose-matching rule</a> is applied to the value of this parameter</li>'
        + "</ul>"
