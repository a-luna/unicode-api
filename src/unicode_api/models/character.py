...
from unicode_api.models.property_values import Decomposition_Type
...
class UnicodeCharacter(UnicodeCharacterBase, table=True):
    __tablename__: str = "character"  # type: ignore  # noqa: PGH003
    ...
    block: "UnicodeBlock" = Relationship(back_populates="characters")
    plane: "UnicodePlane" = Relationship(back_populates="characters")
    general_category: "General_Category" = Relationship(back_populates="characters")
    age: "Age" = Relationship(back_populates="characters")
    combining_class: "Canonical_Combining_Class" = Relationship(back_populates="characters")
    bidi_class: "Bidi_Class" = Relationship(back_populates="characters")
    bidi_paired_bracket_type: "Bidi_Paired_Bracket_Type" = Relationship(back_populates="characters")
    decomposition_type: Decomposition_Type | None = Relationship(back_populates="characters")
    numeric_type: "Numeric_Type" = Relationship(back_populates="characters")
    joining_type: "Joining_Type" = Relationship(back_populates="characters")
    line_break: "Line_Break" = Relationship(back_populates="characters")
    east_asian_width: "East_Asian_Width" = Relationship(back_populates="characters")
    script: "Script" = Relationship(back_populates="characters")
    hangul_syllable_type: "Hangul_Syllable_Type" = Relationship(back_populates="characters")
    vertical_orientation: "Vertical_Orientation" = Relationship(back_populates="characters")


class UnicodeCharacterUnihan(UnicodeCharacterBase, table=True):
    __tablename__: str = "character_unihan"  # type: ignore  # noqa: PGH003
    ...
    block: "UnicodeBlock" = Relationship(back_populates="unihan_characters")
    plane: "UnicodePlane" = Relationship(back_populates="unihan_characters")
    general_category: "General_Category" = Relationship(back_populates="unihan_characters")
    age: "Age" = Relationship(back_populates="unihan_characters")
    combining_class: "Canonical_Combining_Class" = Relationship(back_populates="unihan_characters")
    bidi_class: "Bidi_Class" = Relationship(back_populates="unihan_characters")
    bidi_paired_bracket_type: "Bidi_Paired_Bracket_Type" = Relationship(back_populates="unihan_characters")
    decomposition_type: Decomposition_Type | None = Relationship(back_populates="unihan_characters")
    numeric_type: "Numeric_Type" = Relationship(back_populates="unihan_characters")
    joining_type: "Joining_Type" = Relationship(back_populates="unihan_characters")
    line_break: "Line_Break" = Relationship(back_populates="unihan_characters")
    east_asian_width: "East_Asian_Width" = Relationship(back_populates="unihan_characters")
    script: "Script" = Relationship(back_populates="unihan_characters")
    hangul_syllable_type: "Hangul_Syllable_Type" = Relationship(back_populates="unihan_characters")
    vertical_orientation: "Vertical_Orientation" = Relationship(back_populates="unihan_characters")
